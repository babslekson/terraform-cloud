...
module "AutoScaling" {
  ...
  wordpress-lb-tg  = module.ALB.wordpress-tg
  nginx-lb-tg      = module.ALB.nginx-tg
  tooling-lb-tg    = module.ALB.tooling-tg
